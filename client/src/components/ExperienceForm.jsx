...
const ExperienceForm = ({ data, onChange }) => {
   ...
   const [generatingIndex, setGenerating] = useState(-1)
  ...
  // ✅ Update any field of a specific experience
        ...
        <div className='space-y-4'>
          {data.map((experience, index) => (
            <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
              ...
              {/* Description Box + AI Button (future feature) */}
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full text-sm px-3 py-2 rounded-lg resize-none border border-gray-300 focus:ring focus:ring-blue-500 outline-none"
