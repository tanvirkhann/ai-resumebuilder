            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
             ...
             from-green-500 to-green-600 border-none transition-all duration-2000"
              ...
              <button
                ...
                className="bg-gradient-to-br from-green-100 to-green-200 ring-1 ring-green-300 
              text-green-600 hover:ring-green-400 transition-all rounded-md 
              px-6 py-2 mt-6 text-sm"
              >
                Save Changes
              </button>
