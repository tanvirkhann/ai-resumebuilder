...
const Dashboard = () => {
  ...
  const deleteResume = async (resumeId) => {
    try {
      const conferm = window.confirm('Are you sure you to delete this resume?')
      if (conferm) {
  ...
  return (
    ...
    <div>
      ...
      bg-clip-text text-transparent sm:hidden'>Welcome, {user?.name || "User"}</p>
            ...
            w-full max-w-sm p-6'>
              ...
              <div>
                <label htmlFor='resume-input' className='block text-sm text-slate-700'>
                  ...
                  border-slate-400 border-dashed rounded-md p-4 py-10 my-4 
